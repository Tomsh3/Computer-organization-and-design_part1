...
int printOpcode(char *opcode, FILE *memin)
{
	...
	else if (strcmp(opcode, "res1") == 0)
		fprintf(memin, "%02X", Res1);
	else if (strcmp(opcode, "res2") == 0)
		fprintf(memin, "%02X", Res2);
	else if (strcmp(opcode, "res3") == 0)
		fprintf(memin, "%02X", Res3);
